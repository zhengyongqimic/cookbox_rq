  ...
  return (
    ...
    >
      <div className="relative aspect-video bg-zinc-900 flex items-center justify-center overflow-hidden">
        {/* Placeholder for thumbnail since backend doesn't provide one yet */}
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10" />
        <PlayCircle size={48} className="text-zinc-600 group-hover:text-orange-500 transition-colors z-20" />
        
        {/* Simulated thumbnail effect */}
        <div className="absolute inset-0 bg-zinc-800 opacity-50 group-hover:scale-105 transition-transform duration-500" />
      </div>
